...
public class CalendrierActivity extends ListActivity {
	...
	String[] items;
		public void onCreate(Bundle icicle) {
			...
			Toast.makeText(CalendrierActivity.this,"Veuillez patienter", Toast.LENGTH_SHORT).show();
			Downloader downloader = new Downloader();
			downloader.execute("http://10.0.2.2/codephp/cl1.php");
	...
	setListAdapter(new ArrayAdapter<String>(CalendrierActivity.this,
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			if(item.getItemId()==R.id.menuStade){
				Intent intent=new Intent(CalendrierActivity.this,StadeActivity.class);
