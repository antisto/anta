...
public class ClassementActivity extends ListActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		Toast.makeText(ClassementActivity.this,"Veuillez patienter", Toast.LENGTH_SHORT).show();
		Downloader downloader = new Downloader();
		downloader.execute("http://10.0.2.2/codephp/classement.php");
...
setListAdapter(new ArrayAdapter<String>(ClassementActivity.this,
