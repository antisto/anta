...
public class ResultatActivity extends ListActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		Toast.makeText(ResultatActivity.this,"Veuillez patienter", Toast.LENGTH_SHORT).show();
		Downloader downloader = new Downloader();
		downloader.execute("http://10.0.2.2/codephp/resultats.php");
...
setListAdapter(new ArrayAdapter<String>(ResultatActivity.this,
